...
},{"./cjs/react-dom.development.js":"node_modules/react-dom/cjs/react-dom.development.js"}],"leaderboard.js":[function(require,module,exports) {
"use strict";
...
function (_React$Component) {
  ...
  function Leaderboard() {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(Leaderboard).call(this));
    _this.state = {
      recent: [],
      alltime: [],
      column: "recent"
  ...
  _createClass(Leaderboard, [{
    ...
    value: function render() {
      ...
      return _react.default.createElement("div", {
        ...
        className: "header"
      }, _react.default.createElement("h1", null, this.props.title)), _react.default.createElement(CamperTable, {
        users: users,
        column: this.state.column,
        setColumn: this.setColumn.bind(this)
      }), _react.default.createElement("div", {
        className: "made-by"
      }, footerText, _react.default.createElement("a", {
...
function (_React$Component2) {
  ...
  function CamperTable() {
    ...
    return _possibleConstructorReturn(this, _getPrototypeOf(CamperTable).apply(this, arguments));
  }
  ...
  _createClass(CamperTable, [{
    ...
    value: function render() {
      var camperList = this.props.users.map(function (user, index) {
        return _react.default.createElement(CamperRow, {
          rank: index + 1,
          user: user,
          key: user.username
        });
      ...
      }, "Rank"), _react.default.createElement("div", {
        className: "camper-table-camper"
      }, "Camper"), _react.default.createElement("div", {
        className: recentClass,
        onClick: this.columnSortHandler.bind(this, "recent")
      }, "Points of last 30 days"), _react.default.createElement("div", {
        className: alltimeClass,
        onClick: this.columnSortHandler.bind(this, "alltime")
      }, "All time points")), _react.default.createElement("div", {
...
function (_React$Component3) {
  ...
  function CamperRow() {
    ...
    return _possibleConstructorReturn(this, _getPrototypeOf(CamperRow).apply(this, arguments));
  }
  ...
  _createClass(CamperRow, [{
    ...
    value: function render() {
      ...
      }, this.props.rank), _react.default.createElement("div", {
        className: "camper-row-camper"
      }, _react.default.createElement("a", {
        href: link
      }, _react.default.createElement("img", {
        src: this.props.user.img
      }), this.props.user.username)), _react.default.createElement("div", {
        className: "camper-row-recent"
      }, this.props.user.recent), _react.default.createElement("div", {
...
_reactDom.default.render(_react.default.createElement(Leaderboard, {
...
},{}]},{},["node_modules/parcel-bundler/src/builtins/hmr-runtime.js","leaderboard.js"], null)
//# sourceMappingURL=/leaderboard.4fc84e60.map